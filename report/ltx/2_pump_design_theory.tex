...
Which is the theoretical total pressure a barske impeller generates at the blade tips. Barske introduces a loss coefficient for the kinetic energy which can be recovered through the diffuser to be between 0.2 and 0.5, but