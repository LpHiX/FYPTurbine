...
It links the available inlet pressure directly to the achievable jet velocity, and it is what makes the blade speed problem concrete. A small turbine on a 20,000 RPM shaft has a blade speed of around 100 m/s, while the spouting velocity of even a moderate pressure ratio gas generator is several hundred m/s, so $U/C_0$ is forced far below the optimum of around 0.5.
