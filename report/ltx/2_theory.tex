...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{TODO} % conventional shrouded full-emission impeller
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{placeholder.png}
        \caption{TODO} % Barske open partial-emission impeller
        \label{fig:impeller-barske}
    \end{subfigure}
    \caption{TODO} % Fig 2.1: Barske (open, partial-emission) vs conventional shrouded impeller (hand/CAD)
...
\begin{figure}[H]
    ...
    \caption{TODO} % Fig 2.2: pump velocity triangle / forced-vortex schematic (hand)
...
\begin{figure}[H]
    ...
    \caption{TODO} % Fig 2.3: impulse-turbine velocity triangles (generic; candidate: matplotlib from turbine.py angles)
...
\begin{figure}[H]
    ...
    \caption{TODO} % Fig 2.4: eta vs u/c3 -- ideal (dashed) vs Weiss-real (solid), design point marked
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % Goldman TM X-2095 Fig. 4 (paper scan)
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % this work's reproduction: surface Mach distribution
        \label{fig:goldman-mach-ours}
    \end{subfigure}
    \caption{TODO} % Fig 2.6a: Goldman TM X-2095 "typical case" validation -- Mach distribution (plateaus 2.96/1.84 vs paper ~2.97/1.85)
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % Goldman TM X-2095 Fig. 5 (paper scan)
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % this work's reproduction: incompressible form factor H_i
        \label{fig:goldman-hi-ours}
    \end{subfigure}
    \caption{TODO} % Fig 2.6b: Goldman validation -- H_i; caption must own the honest residual (peak location + separation verdict reproduce, peak magnitude differs)
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % narrow Mach spread (1.25/1.35) -- sliver passage
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{TODO} % wide Mach spread (1.05/1.5) -- wide passage
        \label{fig:moc-spread-wide}
    \end{subfigure}
    \caption{TODO} % Fig 2.5: MoC passage width vs surface-Mach spread (shared axis limits)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{placeholder.png}
    \caption{TODO} % finite leading edge treatments: wedge / incidence angling / in-passage shock cancellation (hand sketch)
    \label{fig:finite-le}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{placeholder.png}
    \caption{TODO} % NASA SP-8120 Fig. 7: conical vs ideal nozzle efficiency vs area ratio
    \label{fig:conical-nozzle-loss}
\end{figure}

\subsubsection{Turbopump Matching}

% STUB (SK-2 gap tracker: not written yet) -- tau_turbine(omega) = tau_pump(omega) + tau_fric(omega);
% pump torque ~ omega^2, turbine torque falls with u/c3; intersection = match point;
% negative relative slope => self-regulating. The theory behind the Ch5 coupled-run demo.
