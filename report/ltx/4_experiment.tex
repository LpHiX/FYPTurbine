...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{shaft_alignment.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{water_pid.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.42\textwidth}
        \centering
        \includegraphics[width=\textwidth]{servo_valves.jpg}
    ...
    \begin{subfigure}[b]{0.54\textwidth}
        \centering
        \includegraphics[width=\textwidth]{setup_valve_kv.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{turbine_pid.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{llllll}
        \toprule
        Quantity & Sensor & Range & Output & Datasheet Uncertainty & Measured Uncertainty\\
        \midrule
