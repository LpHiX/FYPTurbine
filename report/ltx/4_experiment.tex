...
\begin{equation}
    \bar{P} = \frac{\left(P_0 - P_e\right)V_0}{m_c\, \gamma R T_0}
...
\begin{equation}
    E = \tfrac{1}{2} I \omega^2 = \tfrac{1}{2} \times 6\times10^{-5} \times 2094^2 = 131 \textrm{ J}
    \label{eq:blisk_ke}
\end{equation}
...
A 15 mm polycarbonate shield additionally separates the turbomachinery from the dynamometer. Its capacity is estimated with the shear plug model \cite{hazellArmour2015}, where the projectile shears a plug of perimeter $P_{im}$ out of the sheet:

\begin{equation}
    E = \int_0^t P_{im}\, \tau \left(t-x\right) dx = \tfrac{1}{2} P_{im}\, \tau\, t^2
    \label{eq:shear_plug}
\end{equation}
...
\begin{equation}
    \alpha = \frac{\tau}{I} = \frac{0.9}{2.74\times10^{-4}} = 3285 \textrm{ rad/s}^2 \approx 31{,}300 \textrm{ RPM/s}
