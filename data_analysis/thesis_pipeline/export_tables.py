...
COMPARE_TABLES = {
    "tab_model_vs_meas": [
        {"qty": r"head coefficient $\psi$",
         ...
         "note": "Barske design vs measured (5-speed collapse)"},
        {"qty": r"overall efficiency $\eta$ at \valPumpRpmDesign",
         "model": "pump_eta_design", "meas": "pump_eta_extrap",
         "note": "design estimate vs Re-fit extrapolation"},
        {"qty": "shutoff churning power",
         ...
         "note": "measured at shutoff, 15 points"},
        {"qty": r"rotor-inlet relative Mach $M_{w3}$ at test",
         "model": "turb_start_limit", "meas": "turb_mw_test",
         "note": "vs Goldman starting limit $\\rightarrow$ unstarted"},
        {"qty": "coupled shaft torque",
         "model": "turb_torque_started_test", "meas": "coupled_torque",
         "note": "started-flow model vs measured (unstarted rotor)"},
    ],
}
